...
public class TC_8_AddToCart extends BaseClass
{

	@Test(retryAnalyzer = utilityclasses.IRetryAnalyzerMainLogic.class)
	
	public void productAddedToTheCard() throws EncryptedDocumentException, IOException, InterruptedException
	{
		logger.info("**** TC 8 Starterd ****");
