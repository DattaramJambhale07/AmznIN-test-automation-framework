...
public class TC_7_ProductSorting extends BaseClass
{

	@Test(retryAnalyzer = utilityclasses.IRetryAnalyzerMainLogic.class)
	
	public void verifyProductSortedAccrdngToPrice() throws EncryptedDocumentException, IOException, InterruptedException
	{
		logger.info("**** TC 7 Starterd ****");
		...
		srchpg.searchOptions();
		logger.info("Product sorting is done using filters for price, reviews, and relevancy.");
		
		logger.info("**** TC 7 Completed ****");
	}
